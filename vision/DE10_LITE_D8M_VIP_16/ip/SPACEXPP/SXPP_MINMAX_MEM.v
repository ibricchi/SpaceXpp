...
input en;
input [DATA_SIZE-1:0] rad_in [X_SIZE-1:0][Y_SIZE-1:0];
input [DATA_SIZE-1:0] minx_in [X_SIZE-1:0][Y_SIZE-1:0];
input [DATA_SIZE-1:0] maxx_in [X_SIZE-1:0][Y_SIZE-1:0];
input [DATA_SIZE-1:0] miny_in [X_SIZE-1:0][Y_SIZE-1:0];
input [DATA_SIZE-1:0] maxy_in [X_SIZE-1:0][Y_SIZE-1:0];
